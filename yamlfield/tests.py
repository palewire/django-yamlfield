...
class YAMLFieldTest(TestCase):
    ...
    def test_yaml_field_create(self):
        ...
        """
        yaml_obj = {"item_1": "this is a yaml blah", "blergh": "hey, hey, hey"}
        obj = YAMLModel.objects.create(yaml=yaml_obj)
        new_obj = YAMLModel.objects.get(id=obj.id)
        self.assertEqual(new_obj.yaml, yaml_obj)
    ...
    def test_yaml_field_modify(self):
        ...
        self.assertEqual(obj.yaml, yaml_obj_1)
        obj.yaml = yaml_obj_2
        self.assertEqual(obj.yaml, yaml_obj_2)
        obj.save()
        self.assertEqual(obj.yaml, yaml_obj_2)
        self.assertTrue(obj)
    ...
    def test_yaml_field_load(self):
        ...
        obj = YAMLModel.objects.create(yaml=yaml_obj_1)
        new_obj = YAMLModel.objects.get(id=obj.id)
        self.assertEqual(new_obj.yaml, yaml_obj_1)
    ...
    def test_blank_yaml_field(self):
        ...
        new_obj = YAMLModel.objects.get(id=obj.id)
        self.assertEqual(new_obj.yaml, None)
...
('force_encoding', 'utf-8')]))])",
        ...
        self.assertEqual(obj.yaml, data)
